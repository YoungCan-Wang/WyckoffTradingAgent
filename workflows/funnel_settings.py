...
from core.funnel_theme import DEFAULT_THEME_RADAR_MAX_AGE_DAYS
...
MAIN_BENCH_CODE = os.getenv("FUNNEL_MAIN_BENCH_CODE", "000985").strip() or "000985"
...
FUNNEL_THEME_RADAR_MAX_AGE_DAYS = _int_env(
    "FUNNEL_THEME_RADAR_MAX_AGE_DAYS", DEFAULT_THEME_RADAR_MAX_AGE_DAYS, min_value=0
)

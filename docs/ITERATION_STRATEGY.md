...
| A股实证入场 | 弱水温仓位与 NEUTRAL Spring | 默认回测 A/M/P，未验证前不改变生产漏斗 |
...
信号仓位；P 在 M 上将 NEUTRAL 下的 Spring 缩至四分之一仓。N 的“过滤后补位”与 O 的“禁买后空仓”
均未通过五窗口验证，因此已退役。默认对比覆盖近期六个月、2020 牛段、2022 熊段、2023
震荡和 2024 剧烈波动五个窗口，P 必须相对 M 评估，才能观察更低 Spring 仓位是否改善收益/回撤。策略只有在

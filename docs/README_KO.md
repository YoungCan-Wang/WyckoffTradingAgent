...
| 메인라인 퍼널 스크리닝 | A주 전체 시장과 홍콩주 / 미국주 독립 universe를 동적 테마, 8채널 강도, 후보 레인, 타이밍 확인으로 스캔 |
...
기간별 8개 핵심 파라미터 실행, 최적 파라미터, Sharpe 매트릭스, 전략 건강 체크 출력:
...
| L2 | 8채널 강도 | 주상승 / 점화 / 잠복 / 매집 / 극저량 / 호가방어 / 추세 지속 / 돌파 가속 |
...
GitHub Actions와 Codex Automation 기반 일일 자동화:
...
| 백테스트 그리드 | 매월 1일, 15일 04:00 | 8개 핵심 파라미터 → 종합 리포트 |
| DB 유지보수 | 화-토 06:20 | 시세, 주문, 신호, 시장 신호 등 롤링 윈도우 데이터를 정리 |

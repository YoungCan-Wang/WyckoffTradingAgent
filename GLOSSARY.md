...
| **公司大事 / 停复牌扫描** | `scan_corporate_events`：东财关键词与财联社最新批次的最近48小时观察，不是全量公告核对。`source_status` 区分 ok/partial/unavailable；否认、终止、复牌及未知状态独立标识；缺失时间不算近期。只写观察产物和通知，不改漏斗或 OMS。见 [扫描契约](docs/CORPORATE_EVENT_SCAN.md)。 |

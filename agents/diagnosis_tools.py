...
def _diagnostic_payload(d, text: str, latest_date: str, metadata: dict) -> dict:
    ...
    return {
        ...
        "stop_loss_atr": _round_number(getattr(d, "stop_loss_atr", 0.0)),
        "stop_loss_atr_status": getattr(d, "stop_loss_atr_status", "安全"),
        "atr_14": _round_number(getattr(d, "atr_14", 0.0)),
